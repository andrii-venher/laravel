...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 23, 2021 at 04:06 PM
...
(5, '2021_10_22_091953_create_categories_table', 1),
(6, '2021_10_22_194809_create_products_table', 1),
(7, '2021_10_23_115137_create_countries_table', 1),
(8, '2021_10_23_115400_create_regions_table', 1),
(9, '2021_10_23_115908_create_cities_table', 1),
(10, '2021_10_23_120413_create_addresses_table', 1),
(11, '2021_10_23_121045_create_discounts_table', 1),
(12, '2021_10_23_121216_create_units_table', 1),
(13, '2021_10_23_121408_create_producers_table', 1),
(14, '2021_10_23_121729_create_suppliers_table', 1),
(15, '2021_10_23_124211_update_products_table', 1),
(16, '2021_10_23_124635_create_deliveries_table', 1),
(17, '2021_10_23_125057_create_sales_table', 1),
(18, '2021_10_23_125517_update_users_table', 1),
(19, '2021_10_23_125915_update_sales_table', 1);
...
ALTER TABLE `producers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `producers_address_id_foreign` (`address_id`);
...
ALTER TABLE `deliveries`
  ...
  ADD CONSTRAINT `deliveries_supplier_id_foreign` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `producers`
--
ALTER TABLE `producers`
  ADD CONSTRAINT `producers_address_id_foreign` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`) ON DELETE CASCADE;
